...
# S.expandtabs([tabsize])	Возвращает копию строки, в которой все символы табуляции заменяются одним или несколькими
...
# S.rpartition(sep)	Возвращает кортеж, содержащий часть перед последним шаблоном, сам шаблон, и часть после шаблона.
...
# S.ljust(width, fillchar=" ")	Делает длину строки не меньшей width, по необходимости заполняя последние символы
#     символом fillchar
# S.rjust(width, fillchar=" ")	Делает длину строки не меньшей width, по необходимости заполняя первые символы
#     символом fillchar
...
print(len(s))  # 5
s2 = 'HELLO'
print(s.capitalize() + ' ' + s2.capitalize())  # Hello Hello
print(s, s2)  # hello HELLO
print(s + s2)  # helloHELLO
...
s = 'hello world'
print(s.split())  # ['hello', 'world'] - по умолчанию разделитель ' '
